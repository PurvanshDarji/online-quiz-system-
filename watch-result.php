...
// ✅ Fetch ALL Results (no student filter)
...
<title>All Results | Online Quiz System</title>
...
<nav class="navbar">
  ...
  <div>
    <a href="teacher-deshbord.php">Home</a>
    <a href="#">Profile</a>
...
<div class="container">
  ...
  <center>
    <button onclick="window.location.href='teacher-deshbord.php'">Back to Dashboard</button>
  </center>
</div>
